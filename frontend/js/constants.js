...
const welcome_h2 = "Connect MetaMask to Get Started. (Mobile phone users please open MetaMask App then launch browser within MetaMask.)";
const welcome_p = 'We appreciate your patience while we are building. Please help yourself to mint a free NFT - a rose from Galaxy Y! If you like, check out the collection on opensea.io: roses from galaxy y.';
